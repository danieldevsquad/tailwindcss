            ...
            <form
                ...
                <div class="rounded-md shadow-sm -space-y-px">
                    <div>
                        ...
                        <input id="email-address" :disabled="sent"
                    ...
                    <div>
                        ...
                        <input id="password" :disabled="sent"
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        <input id="remember_me"
                               :disabled="sent"
                               name="remember_me" type="checkbox" class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded">
                ...
                <div>
                    <button type="submit"
                            :disabled="sent"
                            class="group disabled:opacity-50 relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
